...
class LV2GSHARED_EXPORT cErrorMessageBox : public QDialog
{
    Q_OBJECT
public:
    explicit cErrorMessageBox(cError * _pe, QWidget *parent = nullptr, const QString &sMainMsg = QString());
    static int messageBox(cError * _pe, QWidget *parent = nullptr, const QString &sMainMsg = QString()) {
        return cErrorMessageBox(_pe, parent, sMainMsg).exec();
    }
    static bool condMsgBox(cError * _pe, QWidget *parent = nullptr, const QString &sMainMsg = QString());
protected:
