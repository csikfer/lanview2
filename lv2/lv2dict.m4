...
STRDEF(NodeParams, "node_params")
 STRDEF(NodeParamId, "node_param_id")
 STRDEF(NodeParamName, "node_param_name")
 STRDEF(NodeParamNote, "node_param_note")
...
dnl type: drawtype
 ...
 STRDEF(STACK, "STACK")
 STRDEF(NONE, "NONE")
STRDEF(RrdBeats, "rrd_beats")
 STRDEF(RrdBeatId, "rrd_beat_id")
 STRDEF(RrdBeatName, "rrd_beat_name")
 STRDEF(RrdBeatNote, "rrd_beat_note")
 STRDEF(Step, "step")
...
STRDEF(SrvDiagramTypes, "srv_diagram_types")
 STRDEF(SrvDiagramTypeId, "srv_diagram_id")
 STRDEF(SrvDiagramTypeName, "srv_diagram_name")
 STRDEF(SrvDiagramTypeNote, "srv_diagram_note")
 dnl text_id height
 STRDEF(Width, "width")
 STRDEF(Rpn, "rpn")
STRDEF(SrvDiagramTypeVars, "srv_diagram_type_vars")
 STRDEF(SrvDiagramTypeVarId, "srv_diagram_type_var_id")
 STRDEF(SrvDiagramTypeVarName, "srv_diagram_type_var_name")
 STRDEF(SrvDiagramTypeVarNote, "srv_diagram_type_var_note")
...
STRDEF(TableShapes, "table_shapes")
 ...
 STRDEF(TablesOnDialogIds, "tables_on_dialog_ids")
...
STRDEF(Tools, "tools")
 ...
 STRDEF(ObjectNames, "object_names")
