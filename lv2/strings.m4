...
STRDEF(TableShapeFields, "table_shape_fields")
 ...
 STRDEF(FilterTypes, "filter_types")
  ...
  STRDEF(NotLike, "notlike")
  STRDEF(NotSimilar, "notsimilar")
  STRDEF(NotRegexp, "notregexp")
  STRDEF(NotRegexpI, "notregexpi")
  STRDEF(NotInterval, "notinterval")
