...
STRDEF(ServiceVarTypes, "service_var_types")
 ...
 STRDEF(Dim, "dim")
 STRDEF(MinValue, "min_value")
 STRDEF(MaxValue, "max_value")
 STRDEF(WarningMax, "warning_max")
 STRDEF(WarningMin, "warning_min")
 STRDEF(CriticalMax, "critical_max")
 STRDEF(CriticalMin, "critical_min")
 dnl features deleted
