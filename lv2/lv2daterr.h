...
class LV2SHARED_EXPORT cDbErr : public cRecord {
    CRECORD(cDbErr);
public:
    static void insertNew(const QString& type, const QString& msg, qlonglong code = -1, const QString& table = _sNil, const QString& func = _sNil);
    static void insertNew(QSqlQuery &q, const QString& type, const QString& msg, qlonglong code = -1, const QString& table = _sNil, const QString& func = _sNil);
};
